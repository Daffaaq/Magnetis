    ...
    <div class="container-fluid">
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                <h6 class="m-0 font-weight-bold text-primary">Edit Mentor Schedule Slot</h6>
            ...
            <div class="card-body">
                <form method="POST"
                    action="{{ route('mentor.batch.assignment.slot-empty.update', [$mentor->id, $assignment->id, $slot->id]) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="date_mentor_schedule_slots" id="date_mentor_schedule_slots"
                            ...
                            value="{{ old('date_mentor_schedule_slots', $slot->date_mentor_schedule_slots) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="time" name="start_time_mentor_schedule_slots" id="start_time_mentor_schedule_slots"
                            ...
                            value="{{ old('start_time_mentor_schedule_slots', $slot->start_time_mentor_schedule_slots) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="time" name="end_time_mentor_schedule_slots" id="end_time_mentor_schedule_slots"
                            ...
                            value="{{ old('end_time_mentor_schedule_slots', $slot->end_time_mentor_schedule_slots) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="location_mentor_schedule_slots" id="location_mentor_schedule_slots"
                            ...
                            value="{{ old('location_mentor_schedule_slots', $slot->location_mentor_schedule_slots) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="url" name="meeting_link_mentor_schedule_slots"
                            ...
                            value="{{ old('meeting_link_mentor_schedule_slots', $slot->meeting_link_mentor_schedule_slots) }}">
                    ...
                    <div class="form-group form-check">
                        <input type="checkbox" class="form-check-input" id="is_booked_mentor_schedule_slots"
                            ...
                            {{ old('is_booked_mentor_schedule_slots', $slot->is_booked_mentor_schedule_slots) ? 'checked' : '' }}>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const selectedStepId = @json(old('intern_selection_step_id', $slot->intern_selection_step_id));
