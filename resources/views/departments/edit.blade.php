                ...
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('department.edit', $department->id) }}"
                            class="{{ request()->routeIs('department.edit') ? 'active' : '' }}">Edit Department</a>
                    </li>
                </ol>
            </div>
                ...
                <form method="POST" action="{{ route('department.update', $department->id) }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description_departments" id="description_departments" rows="4"
                            ...
                            placeholder="Department Description">{{ old('description_departments', $department->description_departments) }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <select name="status_departments" id="status_departments"
                            ...
                            <option value="active"
                                {{ old('status_departments', $department->status_departments) == 1 ? 'selected' : '' }}>
                                Active</option>
                            <option value="inactive"
                                {{ old('status_departments', $department->status_departments) == 0 ? 'selected' : '' }}>
                                Inactive</option>
                        </select>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#descMaxChar').text(maxChar); // Set max on load
