        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="DepartmentsTables" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                <th>No</th>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            var dataTable = $('#DepartmentsTables').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                ...
                columns: [{
                    ...
                    {
                        data: 'status_departments',
                        name: 'status_departments',
                    ...
                    },
                    {
                        ...
                        searchable: false,
                        render: function(data) {
                            let showUrl = `/master-management/department/${data}`;
                            let editUrl = `/master-management/department/${data}/edit`;
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    const url = `/master-management/department/${id}`;
                    $.ajax({
                        url: url,
                        type: 'DELETE',
                        data: {
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                $('#DepartmentsTables').DataTable().ajax.reload();
                            } else {
                                Swal.fire({
                                    icon: 'error',
                                    title: 'Gagal!',
