    ...
    <div class="container-fluid">
        <div class="card shadow mb-4">
                ...
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('internship-offering.create') }}"
                            class="{{ request()->routeIs('internship-offering.create') ? 'active' : '' }}">
                            Create Internship Offering
                        </a>
                    </li>
                </ol>
            </div>
            <div class="card-body">
                ...
                @endif
                <!-- Internship Offering Create Form -->
                <form method="POST" action="{{ route('internship-offering.store') }}">
                    @csrf
                        ...
                        <select name="intern_position_id" id="intern_position_id"
                            ...
                            @foreach ($internPositions as $position)
                                <option value="{{ $position->id }}"
                                    {{ old('intern_position_id') == $position->id ? 'selected' : '' }}>
                        ...
                        <select name="intern_batch_id" id="intern_batch_id"
                            ...
                            @foreach ($internBatches as $batch)
                                <option value="{{ $batch->id }}"
                                    {{ old('intern_batch_id') == $batch->id ? 'selected' : '' }}>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="quota_intern_position_batches" id="quota_intern_position_batches"
                            ...
                            value="{{ old('quota_intern_position_batches') }}" placeholder="Enter Quota">
                    ...
                    <div class="form-group">
                        ...
                        <select name="status_intern_position_batches" id="status_intern_position_batches"
                            ...
                            <option value="active"
                                {{ old('status_intern_position_batches') == 'active' ? 'selected' : '' }}>Active</option>
                            <option value="inactive"
                                {{ old('status_intern_position_batches') == 'inactive' ? 'selected' : '' }}>Inactive
                            </option>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="start_date_intern_position_batches"
                            ...
                            value="{{ old('start_date_intern_position_batches') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="end_date_intern_position_batches" id="end_date_intern_position_batches"
                            ...
                            value="{{ old('end_date_intern_position_batches') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="start_internship_position_batches"
                            ...
                            value="{{ old('start_internship_position_batches') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="end_internship_position_batches" id="end_internship_position_batches"
                            ...
                            value="{{ old('end_internship_position_batches') }}">
                        ...
                        <select name="intern_location_id" id="intern_location_id"
                            ...
                            @foreach ($internLocations as $location)
                                <option value="{{ $location->id }}"
                                    {{ old('intern_location_id') == $location->id ? 'selected' : '' }}>
                    ...
                    <div class="form-group">
                        ...
                        <select name="compensation_intern_position_batches" id="compensation_intern_position_batches"
                            ...
                            <option value="paid"
                                {{ old('compensation_intern_position_batches') == 'paid' ? 'selected' : '' }}>Paid</option>
                            <option value="unpaid"
                                {{ old('compensation_intern_position_batches') == 'unpaid' ? 'selected' : '' }}>Unpaid
                            </option>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="compensation_description_intern_position_batches"
                            ...
                            placeholder="Example: Monthly allowance of Rp1.500.000, transport covered, etc.">{{ old('compensation_description_intern_position_batches') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description_intern_position_batches" id="description_intern_position_batches" rows="4"
                            ...
                            placeholder="Enter description">{{ old('description_intern_position_batches') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="apply_requirements_intern_position_batches" id="apply_requirements_intern_position_batches"
                            ...
                            placeholder="Enter apply requirements">{{ old('apply_requirements_intern_position_batches') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="benefits_intern_position_batches" id="benefits_intern_position_batches" rows="4"
                            ...
                            placeholder="Enter benefits">{{ old('benefits_intern_position_batches') }}</textarea>
