                ...
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item">
                        <a href="{{ route('log-activity.index') }}"
                            class="{{ request()->routeIs('log-activity.index') ? 'active' : '' }}">Log Activity</a>
                    </li>
                </ol>
            </div>
            <div class="card-body">
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            let showUrl = `/setting-management/log-activity/${data}`;
                            return `
                                <a href="${showUrl}" class="btn btn-sm btn-info" title="Lihat">
                                    <i class="bi bi-eye"></i>
                                </a>
                            `;
                        }
