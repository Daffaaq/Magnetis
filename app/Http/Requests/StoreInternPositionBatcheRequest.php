...
class StoreInternPositionBatcheRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'description_intern_position_batches' => 'required|string|max:10000',
            'apply_requirements_intern_position_batches' => 'required|string|max:10000',
            'benefits_intern_position_batches' => 'required|string|max:10000',
