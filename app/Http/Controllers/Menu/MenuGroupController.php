...
class MenuGroupController extends Controller
{
    ...
    {
        $menuGroup = MenuGroup::create($request->validated());

        $this->logUserActivity(
            'Menu Group Created',
            "Created new menu group with ID {$menuGroup->id}",
            auth()->id(),
            $menuGroup
        );
    ...
    public function update(UpdateMenuGroupRequest $request, MenuGroup $menuGroup)
    {
        ...
        $this->logUserActivity(
            'Menu Group Updated',
            "Updated menu group with ID {$menuGroup->id}",
            auth()->id(),
            $menuGroup
        );
